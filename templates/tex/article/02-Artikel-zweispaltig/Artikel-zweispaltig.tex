\documentclass[
  a4paper, 10pt, fleqn, twoside, twocolumn,
  abstract=true
]{scrartcl}
...
% Schiebung zur Bindekorrektur:
% für Schnellhefter auf 5mm setzen, sofern Drucker 10mm Rand zulässt,
% für digitales Lesen auf -2.5mm.
\setlength{\bcorshift}{0mm}

\setlength{\lmargin}{\dimexpr 20mm + \bcorshift\relax}
\setlength{\rmargin}{\dimexpr 15mm - \bcorshift\relax}

\usepackage[a4paper,
  left=\lmargin, right=\rmargin, top=15mm, bottom=20mm,
  includehead, headheight=5mm, headsep=5mm, columnsep=5mm
]{geometry}
...
\bibitem{Heuser1} Harro Heuser: \emph{Lehrbuch der Analysis. Teil 1}.\\
  ...
  {\small\href{https://doi.org/10.1007/978-3-322-94702-4}{doi:10.1007/978-3-322-94702-4}.
